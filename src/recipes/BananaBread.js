        ...
        <div className="mx-auto my-2 py-2 flex flex-col max-w-5xl border-solid border-2 border-cookie">
          ...
          <div className="flex flex-col justify-center mt-2 mx-2">
            ...
            <ol>
              ...
              <li className="mb-4">
                In a large bowl, beat the {getIngredient(0)} and{" "}
                {getIngredient(1)} together with a whisk.
              </li>
              <li className="mb-4">
                Add {getIngredient(2)} and beat well. Mix in {getIngredient(3)}{" "}
                and {getIngredient(4)}
              </li>
              <li className="mb-4">
                Blend in {getIngredient(5)}, {getIngredient(6)},{" "}
                {getIngredient(7)}, and {getIngredient(8)}.
              </li>
              <li className="mb-4">
                Use a big spoon or spatula to stir in {getIngredient(9)}. If you
                are using {getIngredient(10)}, fold those in now.
              </li>
              <li className="mb-4">
                Pour the batter into the loaf pan. You can sprinkle more ground
                cinnamon on top to your liking. Bake for 50-60 minutes, or until
                a toothpick inserted in the center comes out clean.
              </li>
              <li className="">
                When done baking, let the bread cool in the pan for 10-15 more
                minutes, then remove and place on a wire rack to cool further
                before serving.
              </li>
            </ol>
          </div>
